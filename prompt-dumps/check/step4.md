...
- サンプル入力: STEPS[4] のシード例 + 意図的に不正解な解答

### サンプル問

- 日本語: 英語を勉強することは楽しい。
- 模範解答: Studying English is fun.
- 解答（サンプル）: What you want to do?
...
[1]
日本語: 英語を勉強することは楽しい。
模範解答（100点・文法・構造）: Studying English is fun.
構造（圧縮 parts）: Studying English [X] | is [V] | fun [Y]
解答: What you want to do?

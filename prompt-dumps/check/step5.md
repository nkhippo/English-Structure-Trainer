...
- サンプル入力: STEPS[5] のシード例 + 意図的に不正解な解答

### サンプル問

- 日本語: 私が昨日買った本は面白い。
- 模範解答: The book that I bought yesterday is interesting.
- 解答（サンプル）: The book that I buy yesterday is interesting.
...
[1]
日本語: 私が昨日買った本は面白い。
模範解答（100点・文法・構造）: The book that I bought yesterday is interesting.
構造（圧縮 parts）: The book [X] | that I bought yesterday [Y] { that [X] I [X] bought [V] yesterday [Z] } | is [V] | interesting [Y]
解答: The book that I buy yesterday is interesting.

---
id: pj-2026-06-23-c178
aliases:
- pj-2026-06-23-c178
title: Step 7 — 答え合わせ（採点）
created: '2026-06-23'
---
# Step 7 — 答え合わせ（採点）
...
- 模範解答: No longer does she work here.
...
[1]
日本語: もはや彼女はここでは働いていない。
模範解答（100点・文法・構造）: No longer does she work here.
模範解答のポイント: 糸1（助動詞前置）の再利用。否定副詞句を文頭に出した結果、疑問文と同じ助動詞の前置が起きる。
操作タグ: 倒置/強調
糸: 糸1
構造（圧縮 parts）: No longer [Z] | does [V] | she [X] | work [V] | here [Z]

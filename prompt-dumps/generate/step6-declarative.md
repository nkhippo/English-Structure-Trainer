---
id: pj-2026-06-23-b87e
aliases:
- pj-2026-06-23-b87e
title: Step 6 — declarative（問題生成）
created: '2026-06-23'
---
# Step 6 — declarative（問題生成）
...
4. Y+Zキーセンテンス型・副詞節(Z)・名詞節(X)・等位接続 をセット全体で網羅
5. テーマ多様性
...
- × Step6で「〜のですが。」「知りたい…ですか」のハイブリッド・未完文を作らない

...
[例1]
  日本語: 私と一緒に働く人々は、問題が起きたとき一生懸命努力する。
  英語: People who work with me work hard when an issue arises.

[例2]
  日本語: 試験に合格できるように、彼女は一生懸命勉強した。
  英語: She studied hard so that she could pass the exam.
...
疑問文と網羅は別々に積まず、重ねる:
- **ちょうど 2 問**を「当STEPの中心構造を内包した疑問文」にする。間接疑問の wh/if 名詞節(X) や Y+Z キーセンテンス型を疑問文に載せる。

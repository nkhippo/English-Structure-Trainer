...
[例1]
  日本語: 公園を散歩するのが好きな高齢者たちは、毎朝集まる。
  英語: The elderly people who like taking walks in the park gather every morning.

[例2]
  日本語: 昨日あなたに紹介した女性は、私の上司です。
  英語: The woman I introduced to you yesterday is my boss.
...
3. 当STEP範囲の疑問文を 1 問含める（疑問文は当STEPの構造を内包し、網羅を兼ねる）
...
疑問文と網羅は別々に積まず、重ねる:
- 1 問を「当STEPの中心構造を内包した疑問文」にする。各疑問文の Y に関係詞節を載せる（= 関係詞カテゴリのカバーを兼ねる）。

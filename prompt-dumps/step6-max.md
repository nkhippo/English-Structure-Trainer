...
[例1]
  日本語: 彼は試験に合格したいので、一生懸命勉強する。
  英語: He studies hard because he wants to pass the exam.
...
3. 当STEP範囲の疑問文を 5 問含める（疑問文は当STEPの構造を内包し、網羅を兼ねる）
...
疑問文と網羅は別々に積まず、重ねる:
- 5 問を「当STEPの中心構造を内包した疑問文」にする。間接疑問の wh/if 名詞節(X) や Y+Z キーセンテンス型を疑問文に載せる。

...
[例1]
  日本語: もはや彼女はここでは働いていない。
  英語: No longer does she work here.
...
生成手順（必ずこの順番で）:
0. **疑問文 1 問を先に割り当て**（各問 mood=interrogative / questionType / thread を決める — operationTag「疑問」を effectiveTarget 件確保）
